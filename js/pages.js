...
function getFilteredWilayah(sf){var B=window.B,p=sf!=='proyek'?v('wf-proyek'):'',t=sf!=='tahun'?v('wf-tahun'):'';return window.rawBenef.filter(function(r){if(!isProgAllowed(r[B.proyek]))return false;if(p&&r[B.proyek]!==p)return false;var tv=validTgl(r[B.tgl]);if(t==='__blank__'&&tv)return false;if(t&&t!=='__blank__'&&(!tv||!tv.startsWith(t)))return false;return true;});}
