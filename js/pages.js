...
var parokiS={},instansiS={};d.forEach(function(r){if(r[B.paroki])parokiS[r[B.paroki]]=1;if(r[B.lembaga])instansiS[r[B.lembaga]]=1;});
...
var bin=topN(groupCountUniq(d.filter(function(r){return r[B.lembaga];}),function(r){return r[B.lembaga];}),15);mkBarH('wch-instansi',bin.map(function(x){return x[0];}),bin.map(function(x){return x[1];}),'#F59E0B',{label:'Benef Unik'});
